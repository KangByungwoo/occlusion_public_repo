...
class FDForegroundSingleObjectClassifier(nn.Module):
    def __init__(self, input_size=50, input_channels=1, hidden1=64, hidden2=64, hidden3=64, hidden4=1024, n_classes=10, dropout_p=0.5):
        super(FDForegroundSingleObjectClassifier, self).__init__()
...
class FDTallerForegroundSingleObjectClassifier(nn.Module):
    def __init__(self, input_size=50, n_layers=12, input_channels=1, hidden=64, hidden_fc=1024, n_classes=10, dropout_p=0.5):
        super(FDTallerForegroundSingleObjectClassifier, self).__init__()
        self.input_size = input_size
        self.input_channels = input_channels
        self.hidden = hidden
...
class WeightSharedFDTallerForegroundSingleObjectClassifier(nn.Module):
    def __init__(self, input_size=50, n_layers=12, input_channels=1, hidden=64, hidden_fc=1024, n_classes=10, dropout_p=0.5):
        super(WeightSharedFDTallerForegroundSingleObjectClassifier, self).__init__()
        self.input_size = input_size
        self.input_channels = input_channels
        self.hidden = hidden
        self.hidden_fc = hidden_fc
...
class TDRCForegroundSingleObjectClassifierC(nn.Module):
    def __init__(self, reverse=False, n_iter=2, input_size=50, input_channels=1, hidden1=64, hidden2=64, hidden3=64, hidden_lstm=512, n_classes=10, dropout_p=0.5):
        super(TDRCForegroundSingleObjectClassifierC, self).__init__()
...
class TDRCForegroundSingleObjectClassifierD(nn.Module):
    def __init__(self, reverse=False, n_iter=2, input_size=50, input_channels=1, hidden1=64, hidden2=64, hidden3=64, hidden_lstm=512, n_classes=10, dropout_p=0.5):
        super(TDRCForegroundSingleObjectClassifierD, self).__init__()
        self.reverse = reverse
        self.n_iter = n_iter
        self.input_size = input_size
        self.input_channels = input_channels
...
class RCForegroundSingleObjectClassifier(nn.Module):
    def __init__(self, n_iter=2, input_size=50, input_channels=1, hidden1=64, hidden2=64, hidden3=64, hidden_lstm=512, n_classes=10, dropout_p=0.5):
        super(RCForegroundSingleObjectClassifier, self).__init__()
        self.n_iter = n_iter
        self.input_size = input_size
        self.input_channels = input_channels
        self.hidden1 = hidden1
...
class RCControlForegroundSingleObjectClassifier(nn.Module):
    def __init__(self, n_iter=2, input_size=50, input_channels=1, hidden1=64, hidden2=64, hidden3=64, hidden_lstm=512, n_classes=10, dropout_p=0.5):
        super(RCControlForegroundSingleObjectClassifier, self).__init__()
        self.n_iter = n_iter
        self.input_size = input_size
        self.input_channels = input_channels
        self.hidden1 = hidden1
